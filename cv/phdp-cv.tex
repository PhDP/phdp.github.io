...
\textit{E-mail (alt.):} \email{p.desjardinsproulx@ymail.com}\\
...
English \& French, basic knowledge of Japanese.

\section{Professional\\ Interests}

\textbf{Artificial Intelligence; Machine Learning (artificial neural 
networks, probabilistic graphical models); Statistics/Inference; 
Evolutionary Genomics; Molecular Ecology}.

\section{Other \\Interests}

\textbf{Effective Technical Writing in English}; Software Engineering; 
Scientific Computing; Artificial Intelligence in Board Games and for Medical 
Diagnosis; Computational Finance.
...
\begin{innerlist}
  ...
  \begin{innerlist}
    ...
    \item[--] \textbf{Compilers:}           gcc, clang, intel, ghc.
